...
python3 src/teleoperation/scripts/server_rtc.py --cert-file /home/aesir/AESIR/develop/cert.pem --key-file /home/aesir/AESIR/develop/key.pem --host 0.0.0.0 --port 8081