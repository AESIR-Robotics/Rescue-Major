...
```bash
colcon build --packages-select arm_robot_description
...
```bash
ros2 launch arm_moveit_config bringup.launch.py
```
...
```bash
ros2 launch arm_moveit_config bringup_controllers.launch.py
```
...
```bash
ros2 launch arm_moveit_config commander.launch.py
```
...
```bash
ros2 launch arm_moveit_config servo_teleop.launch.py
```
...
```bash
ros2 run arm_moveit_config test_teleop.py
```
...
```bash
ros2 run arm_moveit_config joint_keyboard.py
```
-  Joint 1: `q/a` : (+/-)
-  Joint 2: `w/s` : (+/-)
-  Joint 3: `e/d` : (+/-)
